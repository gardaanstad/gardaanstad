...
export default function BedreOsloPage() {
  return (
    <article className="content-spacing">
      ...
      <p>
        nettsiden er laget for bedre oslo, en organisasjon som jobber for flere boliger, tryggere gater og bedre kollektivt. prosjektet fokuserer på ytelse og brukeropplevelse.
        <InlineLink 
          href="https://bedreoslo.no" 
          text="besøk nettsiden her"
          icon={
